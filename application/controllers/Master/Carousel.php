...
class Carousel extends CI_Controller
{
	...
	public function __construct()
	{
		...
		// Inital Variable
		$this->pagePath = 'Master/Carousel';
		$this->routePath = 'master/carousels';
		$this->breadcrumbs = [
			['Master Data', '#'],
			['Carousel', $this->pagePath],
		];
		...
		// CallModel
		$this->load->model('Master/CarouselModel', 'model');
	}
...
/* Location: ./system/application/controllers/Master/Carousel.php */
