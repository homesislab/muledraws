...
<head>
    ...
    <meta name="keywords" content="Muledraws about, graphic designer, illustrator, portfolio, branding, editorial design, packaging design" />
    <meta name="author" content="Gunali Rezqi Mauludi">
    <link rel="canonical" href="<?= base_url('about'); ?>" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Muledraws | About" />
    <meta property="og:description" content="About Muledraws — portfolio of graphic designer and illustrator Gunali Rezqi Mauludi, working across branding, editorial, packaging, and contemporary art." />
    ...
    <meta name="twitter:title" content="Muledraws | About" />
    <meta name="twitter:description" content="About Muledraws — portfolio of graphic designer and illustrator Gunali Rezqi Mauludi, working across branding, editorial, packaging, and contemporary art." />
        ...
        <main>
            <div id="about" class="row">
                <div class="col-12 col-sm-3">
                    <img src="<?= base_url() . "assets/media/uploads/work/" . $listWork[0]->image; ?>" class="img-fluid mb-3" alt="...">
                    <h3><?= $profileBusiness->bio; ?></h3>
                </div>
                <div class="col-12 col-sm-3">
                    <h2>Selected Clients</h2>
                    <ul>
                        <?php foreach ($listClient as $index => $row) { ?>
                        <li><?= $row->name; ?></li>
                        <?php } ?>
                    </ul>
                </div>
                <div class="col-12 col-sm-3">
                    <h2>Awwards</h2>
                    <ul>
                        <?php foreach ($listAwward as $index => $row) { ?>
                        <li><?= $row->name; ?></li>
                        <?php } ?>
                    </ul>
                </div>
                <div class="col-12 col-sm-3">
                    <h2>Features</h2>
                    <ul>
                        <?php foreach ($listFeature as $index => $row) { ?>
                        <li><?= $row->name; ?></li>
                        <?php } ?>
                    </ul>
                </div>
